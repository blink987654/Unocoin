...
const footerLinks = {
  Products: [
    { label: "Buy Bitcoin", href: "/dashboard" },
    { label: "SBP (Systematic Buying Plan)", href: "/autopilot" },
    { label: "USDT Earnings", href: "/dashboard" },
    { label: "Lightning Network", href: "/dashboard" },
    { label: "Remittance", href: "/remittance" },
    { label: "OTC Desk", href: "/dashboard" },
  ],
  Explore: [
    { label: "AI Advisor", href: "/advisor" },
    { label: "Time Machine", href: "/time-machine" },
    { label: "Bitcoin Kundali", href: "/kundali" },
    { label: "Roz Ka Bitcoin", href: "/daily" },
    { label: "Parivaar Vault", href: "/parivaar" },
